...
public class StoreServiceTest {
    ...
    void Store를_수정한다() {
        ...
        //when
        StoreResponseDto update = storeService.update(id, "주소", StoreCategory.CHICKEN, "치킨", "이쿠", 20000, "032-000-0000", openTime, closeTime);
        ...
        assertThat(update.getMinimum_price()).isEqualTo(20000);
